...
public class UpmsConstant {
	...
	public static final short AUDIT_STAGE_THIRD = 3;    // 三审
	 ...
	 * 1153
	 */
	public static final short AUDIT_SRC_REGISTER = 1;//新注册
	public static final short AUDIT_SRC_CHANGES = 2; //资料变更
	 ...
	 * 1006
	 */
	public static final short CUSTOMER_SERVICE_AREA_XJ = 1;//新疆办事处
	public static final short CUSTOMER_SERVICE_AREA_JN = 2;//济南办事处
	public static final short CUSTOMER_SERVICE_AREA_NJ = 3;//南京办事处
	public static final short CUSTOMER_SERVICE_AREA_ZZ = 4;//郑州办事处
	public static final short CUSTOMER_SERVICE_AREA_XA = 5;//西安办事处
	public static final short CUSTOMER_SERVICE_AREA_ZB = 6;//总部客服中心

	/**
	 * 新旧密码
	 * 1137
	 */
	public static final short PASSWORD_OLD = 1;//旧密码
	public static final short PASSWORD_NEW = 2;//新密码
