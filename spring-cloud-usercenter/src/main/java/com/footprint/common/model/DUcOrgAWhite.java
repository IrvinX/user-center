...
public class DUcOrgAWhite implements Serializable {
    /**
     * ID
     */
    private String id;
    ...
    public DUcOrgAWhite(String id, Short verid, Short auditType, String orgId, String memo, Date expiryDateStt, Date expiryDateEnd, Date createtime, String createuser, Date updatetime, String updateuser) {
        this.id = id;
        this.verid = verid;
