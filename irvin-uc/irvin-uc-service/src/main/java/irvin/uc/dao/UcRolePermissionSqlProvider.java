...
public class UcRolePermissionSqlProvider {
    ...
    public String countByExample(UcRolePermissionExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("uc_role_permission");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(UcRolePermissionExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("uc_role_permission");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String selectByExample(UcRolePermissionExample example) {
        SQL sql = new SQL();
    ...
    protected void applyWhere(SQL sql, UcRolePermissionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
