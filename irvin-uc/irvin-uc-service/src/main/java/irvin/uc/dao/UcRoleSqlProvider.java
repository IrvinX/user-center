...
public class UcRoleSqlProvider {
    ...
    public String countByExample(UcRoleExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("uc_role");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(UcRoleExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("uc_role");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String selectByExampleWithBLOBs(UcRoleExample example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(UcRoleExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("id");
        } else {
    ...
    protected void applyWhere(SQL sql, UcRoleExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
