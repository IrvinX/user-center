...
public class UcUserInternalSqlProvider {
    ...
    public String countByExample(UcUserInternalExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("uc_user_internal");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(UcUserInternalExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("uc_user_internal");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String selectByExample(UcUserInternalExample example) {
        SQL sql = new SQL();
    ...
    protected void applyWhere(SQL sql, UcUserInternalExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
